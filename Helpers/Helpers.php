<?php
	...
	function headerMenu($data=""){
		$view_header_menu = "Views/Template/includes/menu_header.php";
		require_once($view_header_menu);
	}
	function footerMenu($data=""){
		$view_footer_menu = "Views/Template/includes/menu_footer.php";
		require_once($view_footer_menu);
	}
	function dep($data){
		$format = print_r('<pre>');
		$format .= print_r($data);
